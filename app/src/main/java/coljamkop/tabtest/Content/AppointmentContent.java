...
public class AppointmentContent {
    ...
    private static void addItem(Appointment item) {
        ITEMS.add(item);
        ITEM_MAP.put(item.id, item);
    }

    private static Appointment createDummyItem(int position) {
        return new Appointment(String.valueOf(position), "Appointment " + position, makeDetails(position));
    }
    ...
    public static class Appointment {
        ...
        public Appointment(String id, String content, String details) {
            this.id = id;
